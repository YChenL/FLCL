...
def benchmark_all_eval(model, criterion, converter, opt, calculate_infer_time=False):
    ...
    eval_data_list = os.listdir(opt.eval_data)
...
if __name__ == '__main__':
    ...
    """ Testing config """
    parser.add_argument('--eval_data',          type=str, default='/root/autodl-tmp/Databases/eval', help='path to evaluation dataset')
    parser.add_argument('--benchmark_all_eval', type=bool, default=True, help='evaluate 10 benchmark evaluation datasets')
    parser.add_argument('--workers',            type=int, default=4, help='number of data loading workers')
    parser.add_argument('--batch_size',         type=int, default=256, help='input batch size')
    parser.add_argument('--saved_model',        type=str, default='./saved_models/TPS-RCNN-BiLSTM-CTC-CLTrue-Seed2345/best_accuracy.pth',
    ...
    parser.add_argument('--FeatureExtraction', type=str, default='RCNN',help='FeatureExtraction stage. VGG|RCNN|ResNet|EdgeViT|ConvNeXt')
    ...
    if opt.language == 'Zh':
        ...
        str1=''.join(list1)  
        opt.character=opt.character+str1
